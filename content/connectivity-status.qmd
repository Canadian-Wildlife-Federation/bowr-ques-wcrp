...
df = pd.DataFrame({"Goal #": [1,2],
                   "Goal": ["By 2040, the percent (%) of total linear habitat accessible to anadromous salmon will increase from " + str(api.connect_bowr)+"% " + " to 96% within the Bowron River watershed (i.e., reconnect at least "+ str(api.gain_bowr) +" km of habitat).",
                            "By 2024, the total area of overwintering habitat accessible to Anadromous Salmon will increase by 1,500 m2 within the Bowron River watershed. "]
                    })
